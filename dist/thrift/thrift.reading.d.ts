...
export declare function thriftReadToObject<T>(message: Buffer, descriptors: ThriftPacketDescriptor[]): ThriftToObjectResult<T>;
...
//# sourceMappingURL=thrift.reading.d.ts.map